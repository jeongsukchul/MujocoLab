...
class PushT(PipelineEnv):
    def __init__(self, backend: str = "generalized"):
        # get path of mujocolab
        sys = mjcf.load(f"{mujocolab.__path__[0]}/assets/pushT.xml")
    ...
    def reset(self, rng: jnp.ndarray) -> State:
        ...
        obs = self._get_obs(pipeline_state, None)
    ...
    def _get_obs(self, pipeline_state: pipeline.State, state_info) -> jnp.ndarray:
...
def main():
    ...
    path = f"{mujocolab.__path__[0]}/../results/pushT"
